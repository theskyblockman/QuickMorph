...
import fr.drogonistudio.packets_listener.api.event.PacketEvent;
import fr.drogonistudio.packets_listener.api.event.PacketReceiveEvent;
...
public class RemoteClientChannelHandler extends ChannelDuplexHandler
{
     ...
     * 
     * <p>
     * If {@code msg} is a valid Minecraft packet, a new packet event will be
     * created and fired by Bukkit's plugin manager.
     * </p>
     * 
     * @param msg        - data to handle.
     * @param eventClass - {@code PacketEvent} type to fire.
     * @return {@code true} if event haven't been cancelled.
     */
