package fr.drogonistudio.packets_listener.reflective;

import fr.drogonistudio.packets_listener.RemoteClientChannelHandler;
...
public class InjectionUtils
{
    ...
    public static Channel getPlayerChannel(@Nonnull final Player player) throws ReflectiveOperationException
    {
    ...
    public static List<Channel> getServerChannels(Server server) throws ReflectiveOperationException
    {
